...
def get_tw_defence(allycode, number_of_slots):
    ...
    if token_response.status_code == 200:
        ...
        if response.status_code == 200:
            ...
            total_gp = sum(member['gp'] for member in guild_members)
            ...
            slots_per_member = [max(min_slots_per_member, round(member['gp'] * slots_per_gp)) for member in guild_members]
            ...
            while total_slots < number_of_slots:
                ...
                gp_per_slot = [member['gp'] / slot_count for member, slot_count in zip(guild_members, slots_per_member)]
            ...
            print('Error: Failed to fetch guild data from swgoh.help API')
    else:
        print("Error: Failed to fettch API token from swgoh.help API")
